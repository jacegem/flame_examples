...
import 'components/perfect_time.dart';
import 'components/punch_marker.dart';
...
class ShadowTraining extends Game {
  ...
  ShadowTraining(this.ui, this.size) {
    screenScale = size.width / 9;
  ...
  playRandomPunch() {
    int audio = rnd.nextInt(13);
    print(audio);
    Flame.audio.play('swish-${audio + 1}.ogg');
  }
